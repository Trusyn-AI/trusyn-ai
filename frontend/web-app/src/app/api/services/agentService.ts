...
import type { AgentDto } from '../types/auth';
...
export const agentService = {
  ...
  update(agentId: string, payload: Partial<Pick<AgentDto, 'name' | 'description' | 'status' | 'trust_score' | 'permissions' | 'metadata'>>): Promise<AgentDto> {
